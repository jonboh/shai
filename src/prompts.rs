pub const ASK_MODEL_TASK: &str = r#"You are an experienced Linux system administrator whose mission is to fullfil the <task>.
...
pub const EXPLAIN_MODEL_TASK: &str = r#"You are an experienced Linux system administrator whose mission is to clearly explain the provided commands.
